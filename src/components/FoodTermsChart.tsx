...
function computeFoodTerms(raw: string): YearRow[] {
...
const data = computeFoodTerms(adsJsonl)

export function FoodTermsChart() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Comida: términos saludables</CardTitle>
        <CardDescription>
          Porcentaje de anuncios por año que mencionan términos de comida
          ("bio", "eco", "azúcar")
        </CardDescription>
      </CardHeader>
